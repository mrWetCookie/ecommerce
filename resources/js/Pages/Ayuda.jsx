  ...
  useEffect(() => {
    ...
    return (
        <div class="">
            ...
            <div class="mt-10 mb-10 lg:mr-20 lg:ml-20 ml-10 mr-10">
                <div class="text-3xl text-slate-700 m-2">Ayuda</div>
                
                <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5">
                <Link class="bg-gray-100 mt-5 p-5 m-2 h-auto rounded-xl hover:bg-gray-200">
                    <h1 class="text-2xl font-semibold text-slate-700">Administrar y cancelar compras</h1>
                    <p class="text-slate-500 text-sm">Puedes cancelar artículos o pedidos que aún no hayan ingresado al proceso de envío</p>
                </Link>

                <Link class="bg-gray-100 mt-5 p-5 m-2 h-auto rounded-xl hover:bg-gray-200">
                    <h1 class="text-2xl font-semibold text-slate-700">Devoluciones</h1>
                    <p class="text-slate-500 text-sm">Puedes devolver muchso artículos elegibles en Rubic. Cuando devuelves un artículo, es posible que veas diferentes opciones de devolución...</p>
                </Link>

                <Link class="bg-gray-100 mt-5 p-5 m-2 h-auto rounded-xl hover:bg-gray-200">
                    <h1 class="text-2xl font-semibold text-slate-700">Reembolsos</h1>
                    <p class="text-slate-500 text-sm">Cuando devuelves un producto, el monto y el método del reembolso pueden variar. Puedes verificar el método de pago al que se reembolsó y el estado de...</p>
                </Link>

                <Link class="bg-gray-100 mt-5 p-5 m-2 h-auto rounded-xl hover:bg-gray-200">
                    <h1 class="text-2xl font-semibold text-slate-700">¿Necesitas más ayuda?</h1>
                    <p class="text-slate-500 text-sm">Contáctanos</p>
                </Link>
                </div>
            </div>
