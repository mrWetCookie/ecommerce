  ...
  useEffect(() => {
    ...
    return (
        <div class="">
            ...
            {/* Mostrar confeti con animación de opacidad */}
            {showConfetti && (
                <Confetti
                    style={{
                        opacity: opacity,
                        transition: 'opacity 2s ease-out', // Transición suave
                    }}
                />
            )}


            <div class="lg:mx-40 mx-4 my-10 bg-gray-100 rounded-lg">
                <div class=" p-5 flex bg-emerald-600 rounded-t-lg">
                    <p class="md:text-5xl font- text-white text-2xl w-3/4 items-center flex px-5">¡Te avisaremos cuando tu compra esté en camino!</p>
                    <div class="w-1/4 items-center flex justify-center"><div class="rounded-full p-3 bg-white"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="size-10 text-cyan-500"> <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z" /> </svg></div>
                    </div>
                </div>
                <div class="mx-2 py-2">
                    <div class="text-3xl text-slate-700 ml-10 my-5">Se enviara a esta dirección</div>

                    <div class="grid lg:grid-cols-2 lg:gap-2 md:grid-cols-2 gap-1 my-10 space-x-2 lg:mx-10 mx-5">
                    
                    <article class="w-full bg-white m-2 p-5 rounded-lg  border-2  flex-wrap flex">
                    <div class="">
                        ...
                        <p>Ciudad</p>
                        <p>Telf.</p>
                        <Link href="#" class="hover:underline cursor-pointer text-blue-500">Agregas instrucciones de entrega</Link><br/>
                    </div>
                    </article>

                    <article class="w-full bg-white m-2 p-5 rounded-lg items-center justify-center border-2  flex-wrap flex">

                    <img class="lg:h-32 h-44 w-auto object-cover rounded-lg " src="/img/noAv.png"/>
                    <div class="place-content-between pb-2 space-y-5 px-2">
                        <p class="text-xl pb-4">{name}</p>

                        <div class="flex items-end space-x-2">
                        <p class="hover:underline cursor-pointer text-blue-500">Enviar mensaje</p>
                        <p class="">|</p>
                        <p class="text-slate-800">Apple(Vendedor)</p>
                        </div>
                    </div>                  
                    </article>
