  ...
  useEffect(() => {
    ...
    return (
        <div class="">
            ...
            {/* <button class="border-2" onClick={increment}>Incrementa</button>
            <button class="border-2" onClick={decrement}>Decrementar</button>
            <button class="border-2" onClick={reset}>Reiniciar</button> */}
            
            <div class="relative flex-1">
                <Link class="cursor-pointer" href="">
                <div class="absolute left-0 right-0 z-10 p-4 text-center items  text-violet-100">
                    <h3 class="text-5xl font-bold mt-20">Oferta en tus marcas favoritas</h3>
                    <div class="justify-center items-end">
                        Hasta
                        <h2 class="text-3xl font-semibold">35% + 10%</h2>
                    </div>
                    <p>de descuento | cupon diario</p>
                </div>
                <div class="overflow-hidden h-80 bg-gray-200 w-full"><img class="h-full w-full object-cover" src="/img/befehw.png" alt="Imagen" /></div>
                </Link>
            </div>
